...
def apply_patch() -> None:
    ...
    try:
        ...
        print(f"[TE-Plugin] MUSA backend not available: {e}")
    ...
    try:
        ...
        print(f"[TE-Plugin Musa] Error setting TE device type or platform: {e}")
    ...
    for parent, attr, replacement in _PATCH_CALLS:
        ...
        try:
            ...
            continue
    print(f"[TE-Plugin] MUSA backend patches applied")

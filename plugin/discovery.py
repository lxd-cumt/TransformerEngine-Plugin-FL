...
PLUGIN_GROUP = "te_plugin"

PLUGIN_MODULES_ENV = "NVTE_PLUGIN_MODULES"
...
def _call_register_function(
    ...
    register_fn = getattr(obj, "te_plugin_register", None) or getattr(obj, "register", None)
...
def discover_plugin(registry_module: Any) -> int:
    ...
    1. Entry points (group: 'te_plugin')
    2. Environment variable modules (NVTE_PLUGIN_MODULES)

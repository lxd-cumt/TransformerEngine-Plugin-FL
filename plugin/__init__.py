...
This package provides:
  ...
  - Backend implementations under plugin.backends.*
...
from plugin.types import BackendImplKind, OpImpl, match_token
from plugin.registry import OpRegistry
...
from plugin.manager import OpManager, get_default_manager, reset_default_manager
...
from plugin.stub import install_stub

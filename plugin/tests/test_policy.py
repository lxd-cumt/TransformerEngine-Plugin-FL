...
class TestPolicyManager(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        from plugin.policy import reset_global_policy
...
class TestEnvironmentVariables(unittest.TestCase):
    ...
    def test_nvte_prefer_flagos(self):
        ...
        from plugin.policy import policy_from_env
...
class TestTokenMatching(unittest.TestCase):
    ...
    def test_match_flagos_token(self):
        ...
        from plugin.types import OpImpl, BackendImplKind, match_token
...
class TestDefaultOrder(unittest.TestCase):
    ...
    def test_flagos_preference_order(self):
        ...
        from plugin.policy import SelectionPolicy
